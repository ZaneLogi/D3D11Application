...
void BitmapModel::set_screen_size(int width, int height)
{
    m_screenWidth = width;
...
bool BitmapModel::render(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
...
bool BitmapModel::initialize_buffers(ID3D11Device* device)
{
    VertexType* vertices;
...
void BitmapModel::shutdown_buffers()
{
...
bool BitmapModel::update_buffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
...
void BitmapModel::render_buffers(ID3D11DeviceContext* deviceContext)
{
    unsigned int stride;
    unsigned int offset;
...
bool BitmapModel::load_texture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename)
{
...
void BitmapModel::release_texture()
{
